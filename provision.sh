...
# Install tmux
su - vagrant -c 'cd /home/vagrant && wget https://github.com/tmux/tmux/releases/download/2.8/tmux-2.8.tar.gz'
su - vagrant -c 'cd /home/vagrant && tar -xzf tmux-2.8.tar.gz'
su - vagrant -c 'cd /home/vagrant/tmux-2.8 && ./configure && make'
cd /home/vagrant/tmux-2.8 && sudo make install
